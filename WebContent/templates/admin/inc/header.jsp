...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/templates/admin/css/normalize.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/templates/admin/css/themify-icons.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/templates/admin/css/flag-icon.min.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/templates/admin/css/cs-skin-elastic.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/templates/admin/css/lib/datatable/dataTables.bootstrap.min.css">
<!-- <link rel="stylesheet" href="/templates/admin/css/bootstrap-select.less"> -->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/templates/admin/scss/style.css">
<link
	href="<%=request.getContextPath()%>/templates/admin/css/lib/vector-map/jqvmap.min.css"
	rel="stylesheet">
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/templates/admin/ckfinder/ckfinder.js"></script>
...
<body>
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="./"><img
			src="<%=request.getContextPath()%>/templates/admin/images/logo.png"
	...
	<div id="main-menu" class="main-menu collapse navbar-collapse">
		<ul class="nav navbar-nav">
			<li class="active"><a href="<%=request.getContextPath()%>/admin">
					<i class="menu-icon fa fa-dashboard"></i>Admin
			</a></li>
			<h3 class="menu-title">UI elements</h3>
			<!-- /.menu-title -->

			<li><a href="<%=request.getContextPath()%>/admin/users"> <i
					class="menu-icon ti-user"></i>Người dùng
			</a></li>
			<li><a href="<%=request.getContextPath()%>/admin/cat"> <i
					class="menu-icon fa fa-bookmark-o"></i>Danh mục
			</a></li>
			<li><a href="<%=request.getContextPath()%>/admin/news"> <i
					class="menu-icon ti-pencil-alt"></i>Tin tức
			</a></li>
		</ul>
	</div>
						...
						<div class="dropdown-menu" aria-labelledby="message">
							...
							<a class="dropdown-item media bg-flat-color-1" href="#"> <span
								class="photo media-left"><img alt="avatar"
									src="<%=request.getContextPath()%>/templates/admin/images/avatar/1.jpg"></span>
								...
								class="photo media-left"><img alt="avatar"
									src="<%=request.getContextPath()%>/templates/admin/images/avatar/2.jpg"></span>
								<span class="message media-body"> <span
								...
								class="photo media-left"><img alt="avatar"
									src="<%=request.getContextPath()%>/templates/admin/images/avatar/3.jpg"></span>
								<span class="message media-body"> <span
								...
								class="photo media-left"><img alt="avatar"
									src="<%=request.getContextPath()%>/templates/admin/images/avatar/4.jpg"></span>
								<span class="message media-body"> <span
			...
			<div class="col-sm-5">
				<div class="user-area dropdown float-right">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"
						...
						src="<%=request.getContextPath()%>/templates/admin/images/admin.jpg"
						alt="User Avatar">
					</a>
